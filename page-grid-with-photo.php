...
<section class="grid">
   ...
   <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="700" id="post-<?php the_ID(); ?>" <?php post_class("grid__item aos-item grid-img_s"); ?>>
      <a class="full-img grid-img mobile-img-s" href="<?php the_permalink(); ?>">
